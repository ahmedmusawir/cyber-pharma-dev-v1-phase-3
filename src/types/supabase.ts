...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      is_account_member: { Args: { acct: string }; Returns: boolean }
      is_admin_of: { Args: { biz: string }; Returns: boolean }
      is_member_of: { Args: { biz: string }; Returns: boolean }
