...
| **AC3** spoof drills | ✅ all five named cases + 23 more: **28 cases, 0 breaches, 0 ground-truth mismatches** | `X4_attacks_2026-09-01T0649.log` — (a) A2.1 `42501` · (b) A3.1 re-home refused, `business_id` unchanged · (c) A5.1 self-promotion refused, role still `member` · (d) A1.1 account A → 0 rows · (e) A1.2 subscription A → 0 rows |
